...
interface Props {
  input: AlzheimerPrognosis2yrBasicInput;
  prognosis: AlzheimerPrognosis2yrBasicOutput;
  onReset: () => void;
}

export default function Prog2yrBasicResult({ input, prognosis, onReset }: Props) {
  ...
  const safeWidth = (value?: number | null) => {
  ...
  return (
    <div className="mt-6 border border-gray-200 rounded-lg bg-white shadow-sm">
      ...
      <div className="bg-gradient-to-r from-purple-50 to-indigo-50 px-6 py-4 border-b border-gray-200 rounded-t-lg">
        <h2 className="text-2xl font-bold text-gray-800">🧠 Alzheimer’s 2-Year Prognosis</h2>
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-white p-4 rounded-lg border border-purple-200">
              ...
              <div className="mt-2 w-full bg-gray-200 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: safeWidth(prognosis.probability_progression_to_AD_within_2yrs),
                  }}
                />
              </div>
            </div>
            ...
            <div className="bg-white p-4 rounded-lg border border-purple-200">
              ...
              <div className="mt-2 w-full bg-gray-200 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: safeWidth(prognosis.probability_stable_within_2yrs),
                  }}
                />
              </div>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              >
                {formatFieldName(prognosis.risk_level || "Unknown")} Risk
              </span>
            </div>
