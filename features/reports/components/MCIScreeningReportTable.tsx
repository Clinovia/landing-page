...
import { MCIScreeningReport } from "../types";

interface MCIScreeningReportTableProps {
  reports: MCIScreeningReport[];
  loading: boolean;
}

export const MCIScreeningReportTable: React.FC<MCIScreeningReportTableProps> = ({ reports, loading }) => {
