export default function CardiologyLoading() {
  return (
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {[...Array(5)].map((_, i) => (
            ...
            >
              {/* Icon */}
              <div className="mb-4 h-12 w-12 rounded-lg bg-red-100"></div>
        ...
        <div className="mt-6 animate-pulse rounded-lg border border-red-200 bg-red-50 p-4">
          <div className="mb-3 h-5 w-40 rounded bg-red-200"></div>
          <div className="space-y-2">
            <div className="h-3 w-full rounded bg-red-200"></div>
            <div className="h-3 w-5/6 rounded bg-red-200"></div>
          </div>
        </div>
      </div>
    </div>
