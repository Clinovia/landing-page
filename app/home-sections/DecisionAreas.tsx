...
export default function DecisionAreas() {
  ...
  return (
    <section id="decision-areas" className="py-16 bg-white w-full">
      <div className="max-w-7xl mx-auto px-12">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div
            className="bg-gray-50 text-[#1B4D3E] rounded-2xl p-6 shadow-sm flex flex-col border border-gray-200"
            style={{ width: "90%" }}
          >
            <div className="mb-4">
              <img
